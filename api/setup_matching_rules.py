...
PRINCIPAL_IGNORE_LIST = [
    ...
    # New York Corporate Registered Agents (Names)
    'UNITED STATES CORPORATION AGENTS, INC.', 'UNITED STATES CORPORATION AGENTS INC',
    'CORPORATION SERVICE COMPANY', 'REGISTERED AGENTS INC', 'REGISTERED AGENTS INC.',
    'C T CORPORATION SYSTEM', 'CT CORPORATION SYSTEM', 'COGENCY GLOBAL INC.', 'COGENCY GLOBAL INC',
    'NORTHWEST REGISTERED AGENT LLC', 'NORTHWEST REGISTERED AGENT, LLC',
    'UNITED CORPORATE SERVICES, INC.', 'UNITED CORPORATE SERVICES INC',
    'LEGALINC CORPORATE SERVICES INC.', 'LEGALINC CORPORATE SERVICES INC',
    'URS AGENTS LLC', 'URS AGENTS, LLC', 'INCORP SERVICES, INC.', 'INCORP SERVICES INC',
    'CAPITOL SERVICES, INC.', 'CAPITOL SERVICES INC', 'CORPCONEX LLC',
