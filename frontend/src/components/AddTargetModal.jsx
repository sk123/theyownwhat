...
export default function AddTargetModal({ isOpen, onClose, onAdd }) {
    ...
    return (
        <div className="fixed inset-0 z-[200] overflow-y-auto bg-slate-900/50 backdrop-blur-sm px-4 pt-16 pb-4 flex justify-center items-start md:items-center md:p-4" onClick={onClose}>
